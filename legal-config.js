    ...
    sections: [
      {
        title: "一、我们如何处理信息",
        body:
          "同意后，本游戏会在已配置平台通过 Firebase Analytics 上报基础游戏事件，例如初始化成功、开始游戏、游戏结束和设置选择。不收集账号、定位、通讯录、相机、麦克风等敏感权限数据。",
      },
      {
        title: "二、本地保存",
        body:
      ...
      },
      {
        title: "三、统计、广告与支付",
        body:
          "数据统计可在设置中关闭，撤回同意会同时关闭统计。当前版本不接入真实广告或应用内购买，不会展示广告或发起支付；若未来接入，我们会先更新本政策并重新获取必要同意。",
      },
      {
        title: "四、未成年人和内容分级",
        body:
