...
const translations = {
  zh: {
    ...
    guide: {
      quickStart: "先选一组对阵，30 秒看胜负，再挑战反制阵容。",
    ...
    messages: {
      ...
      matchRecordingUnsupported: "当前浏览器不支持自动录屏，可换 Chrome/Edge 再试",
      matchRecordingFailed: "本局录屏失败，请再试一次",
      matchRecordingReady: "本局录屏已就绪：{tags}",
      matchRecordingSaved: "已开始下载录屏：{fileName}",
      matchRecordingSaving: "正在保存本局 Short...",
      matchRecordingNativeSaved: "本局 Short 已保存到相册/影片库",
      matchRecordingSharing: "正在准备分享本局 Short...",
      matchRecordingShared: "本局 Short 已交给系统分享",
      matchRecordingShareCancelled: "已取消分享本局 Short",
      matchRecordingShareFailed: "分享不可用，已改为保存视频",
    ...
    main: {
      subtitle: "主菜单",
      title: "选一组对阵",
      summary: "当前对阵：{professionA} vs {professionB}  /  场景：{scene}",
      itemSummary: "当前对阵：道具乱斗  /  {scene}  /  随机拾取道具",
      quickStart: "开始这组对阵",
      start: "选择对阵",
      reports: "战报",
      settings: "设置与协议",
      ...
      notice: "统计仅在同意后启用；当前版本不展示广告，也不会发起广告请求。上架时请按轻微卡通/幻想对战填写内容评级问卷。",
    },
    playlist: {
      title: "今日对局",
      ...
      railgunCheck: { title: "磁轨试射", tagline: "静电先充满，还是磁轨先点中" },
      loopBreaker: { title: "回旋克星", tagline: "悠悠球拉扯遇到预判点射" },
      stormLab: { title: "雷暴实验室", tagline: "工匠埋伏落雷，宙斯抢天神时机" },
    },
    collection: {
      title: "轻收藏",
    ...
    settings: {
      ...
      restore: "恢复购买",
      withdraw: "撤回同意",
      statsInfo: "统计：{analytics}。{iap}：未配置真实商品。当前版本不展示广告。",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          {
            title: "三、统计与支付",
            body: "数据统计可在设置中关闭，撤回同意会关闭统计并要求重新确认协议。当前版本不展示广告，也不会发起广告请求。当前版本不接入应用内购买，不会发起支付。",
          },
          {
            title: "四、未成年人和内容分级",
    ...
    result: {
      ...
      sourceWeb: "蛛网",
      sourceFlame: "火焰路径",
      recordingReady: "录屏已就绪：{tags}",
      recordingPending: "录屏封装中，稍等一下...",
      recordingUnsupported: "当前浏览器不支持录屏",
      recordingFailed: "录屏失败：{reason}",
      recordingTagPerfect: "一滴血不掉",
      recordingTagComeback: "逆风反杀",
      recordingTagClutch: "残血收割",
      recordingTagStomp: "碾压局",
      recordingTagEndurance: "长线拉扯",
      recordingTagDraw: "同步倒地",
      recordingTagSignature: "{source}名场面",
      recordingTagClose: "险胜收尾",
      recordingTagNormal: "可备选素材",
      recordingDanmakuStart: "本局素材录制中：{matchup}",
      recordingDanmakuResult: "{winner}，运营标签：{tags}",
      recordingDanmakuPerfect: "{side} 这局真就一滴血不掉？",
      recordingDanmakuComeback: "{side} 逆风还敢回头，剪它！",
      recordingDanmakuClutch: "{side} 残血不退，最后一口气立功。",
      recordingDanmakuStomp: "{side} 这把是速通现场。",
      recordingDanmakuEndurance: "{side} 把比赛拖成耐力片了。",
      recordingDanmakuDraw: "双双倒地，这个结局有点会演。",
      recordingDanmakuSignature: "{side} 靠 {source} 打出封面镜头。",
      recordingDanmakuClose: "{side} 险胜，结算页都在擦汗。",
      again: "再来一局",
      shareCard: "生成战报图",
      downloadRecording: "下载本局录屏",
      saveShort: "保存 Short",
      shareShort: "分享 Short",
      rewardedEncoreWatch: "看广告解锁高能连战",
      rewardedEncoreStart: "开启高能连战",
      nextChallenge: "马上挑战反制：{role}",
      nextRevenge: "复仇阵容：{role}",
      nextDrawBreaker: "打破平局：{role}",
      nextItemChaos: "道具反制加码",
      counterReasonChallenge: "{counterRole} 能挡住 {winnerRole} 的开场压制吗？",
      counterReasonRevenge: "换上 {counterRole}，马上复仇 {winnerRole}。",
      counterReasonDrawBreaker: "让 {counterRole} 打破僵局，看看下一局谁会赢。",
      counterReasonItemChaos: "加一颗球，让随机道具把第二局搅起来。",
      setup: "开战设置",
      backMain: "返回主菜单",
    },
    shareTargets: {
      title: "选择分享渠道",
      recordingTitle: "分享本局 Short",
      facebook: "Facebook",
      tiktok: "TikTok",
      system: "系统分享",
      cancel: "取消",
    ...
    recordingShare: {
      title: "Profession Ball Arena Short",
      text: "New Profession Ball Arena Short: {winner}\nClip tags: {tags}\nWatch or replay the matchup here:\n{link}",
    },
    reportCard: {
      eyebrow: "像素战报 · 适合转发",
      reasonLabel: "胜因",
    ...
    professions: {
      ...
      railgun: { name: "磁轨球", skill: "预判磁轨", item: "磁轨短弩" },
    ...
    heroes: {
      ...
      stormEngineer: { name: "磁暴工匠", weapon: "线圈短弓", skills: { stormBeacon: "风暴信标", voltageTrap: "伏特陷阱" } },
  ...
  en: {
    ...
    hud: { shake: "Shake" },
    guide: {
      quickStart: "Pick a matchup, watch the battle, then try the counter.",
    ...
    messages: {
      ...
      matchRecordingUnsupported: "This browser cannot record matches automatically. Try Chrome or Edge",
      matchRecordingFailed: "This match recording failed. Try again",
      matchRecordingReady: "Match recording is ready: {tags}",
      matchRecordingSaved: "Recording download started: {fileName}",
      matchRecordingSaving: "Saving this Short...",
      matchRecordingNativeSaved: "Short saved to your gallery",
      matchRecordingSharing: "Preparing this Short for sharing...",
      matchRecordingShared: "Short sent to system sharing",
      matchRecordingShareCancelled: "Short sharing cancelled",
      matchRecordingShareFailed: "Sharing is unavailable, so the video was saved instead",
    ...
    consent: {
      ...
      intro: "Please read and accept the Privacy Policy and User Agreement.",
    ...
    main: {
      ...
      summary: "Matchup: {professionA} vs {professionB}  /  Scene: {scene}",
      itemSummary: "Matchup: item chaos  /  {scene}  /  random item pickups",
      quickStart: "Start the Duel",
      start: "Pick Matchup",
      reports: "Reports",
    ...
    playlist: {
      ...
      railgunCheck: { title: "Railgun Check", tagline: "Will static charge first, or will the rail shot land?" },
      loopBreaker: { title: "Loop Breaker", tagline: "Yo-yo spacing meets a predictive shot" },
      stormLab: { title: "Storm Lab", tagline: "The engineer traps lightning while Zeus times the descent" },
    },
    collection: {
    ...
    settings: {
      ...
      statsInfo: "Analytics: {analytics}. {iap}: no real products. This build does not show ads.",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          {
            title: "3. Analytics and Payments",
            body: "Analytics can be turned off in Settings, and withdrawing consent disables analytics until the terms are confirmed again. This build does not show ads or make ad requests. In-app purchases remain unconfigured and no payment flow is started.",
          },
          {
    ...
    result: {
      ...
      verdictTitle: "Verdict is in: {result}",
      ...
      recordingReady: "Recording ready: {tags}",
      recordingPending: "Packaging recording...",
      recordingUnsupported: "This browser cannot record matches",
      recordingFailed: "Recording failed: {reason}",
      recordingTagPerfect: "No-Damage Win",
      recordingTagComeback: "Comeback Kill",
      recordingTagClutch: "Low-HP Finish",
      recordingTagStomp: "Stomp",
      recordingTagEndurance: "Long Tug",
      recordingTagDraw: "Double Drop",
      recordingTagSignature: "{source} Highlight",
      recordingTagClose: "Close Finish",
      recordingTagNormal: "Backup Clip",
      recordingDanmakuStart: "Recording clip: {matchup}",
      recordingDanmakuResult: "{winner}. Clip tags: {tags}",
      recordingDanmakuPerfect: "{side} really took zero damage?",
      recordingDanmakuComeback: "{side} turned the deficit into the trailer.",
      recordingDanmakuClutch: "{side} refused to leave at low HP.",
      recordingDanmakuStomp: "{side} just speedran this match.",
      recordingDanmakuEndurance: "{side} dragged this into an endurance reel.",
      recordingDanmakuDraw: "Both dropped together. That ending knew the camera.",
      recordingDanmakuSignature: "{side} made {source} the thumbnail moment.",
      recordingDanmakuClose: "{side} barely closed it. Result screen needs air.",
      again: "Play Again",
      shareCard: "Share Card",
      downloadRecording: "Download Recording",
      saveShort: "Save Short",
      shareShort: "Share Short",
      rewardedEncoreWatch: "Watch Ad for Encore",
      rewardedEncoreStart: "Start Reward Encore",
      nextChallenge: "Try the Counter: {role}",
      nextRevenge: "Run Revenge: {role}",
      nextDrawBreaker: "Break the Draw: {role}",
      nextItemChaos: "Try Item Chaos",
      counterReasonChallenge: "Can {counterRole} stop {winnerRole} next?",
      counterReasonRevenge: "Try {counterRole} into {winnerRole}'s pressure.",
      counterReasonDrawBreaker: "Let {counterRole} break the draw.",
      counterReasonItemChaos: "Add another ball and let the items twist round two.",
      setup: "Battle Setup",
      backMain: "Back to Menu",
    },
    shareTargets: {
      title: "Share To",
      recordingTitle: "Share Short",
      facebook: "Facebook",
      tiktok: "TikTok",
      system: "System Share",
      cancel: "Cancel",
    ...
    professions: {
      ...
      railgun: { name: "Railgun Ball", skill: "Predictive Rail", item: "Coil Bow" },
    ...
    heroes: {
      ...
      stormEngineer: { name: "Storm Engineer", weapon: "Coil Bow", skills: { stormBeacon: "Storm Beacon", voltageTrap: "Voltage Trap" } },
  ...
  fr: {
    ...
    consent: {
      ...
      intro: "Veuillez lire et accepter la Politique de confidentialité et le Contrat utilisateur.",
    ...
    main: {
      ...
      quickStart: "Combat rapide",
      start: "Jouer",
      reports: "Rapports",
      settings: "Réglages & accords",
      dailyProgressTitle: "Objectifs du jour",
      dailyWins: "Victoires",
      dailyMatches: "Combats",
      masteryTitle: "Maîtrise",
      masteryLine: "{role} niv.{level}, {matches} combats joués",
      masteryEmpty: "Débloqué après un combat rapide",
      lastResultTitle: "Cause de la dernière victoire",
      funStatsLine: "Stats fun : favori {favorite} · pire flop {flop} · défaite la plus courte {shortestLoss} · plus long duel {longestMatch} · victimes de la carte {mapVictims}",
      statNone: "Aucun",
      statSeconds: "{seconds}s",
      notice: "Les statistiques ne fonctionnent qu'après accord. Cette version n'affiche pas de publicités et n'envoie aucune demande publicitaire. Pour les stores, indiquez un combat cartoon/fantasy léger.",
    },
    playlist: {
      title: "Playlist du jour",
      rangedDerby: { title: "Duel à distance", tagline: "Flèches et sorts se disputent la caméra" },
      shieldTrial: { title: "Test du bouclier", tagline: "Le bouclier fait des heures sup" },
      assassinDare: { title: "Défi de l'assassin", tagline: "Corps à corps, mauvais choix, grand spectacle" },
      frostBurn: { title: "Glace et braise", tagline: "Le contrôle et le feu sabotent le plan" },
      summonerPanic: { title: "Panique de l'invocateur", tagline: "L'ours peut-il arrêter la faux ?" },
      classicBrawl: { title: "Bagarre classique", tagline: "Lance et lame règlent ça sans détour" },
    },
    collection: {
      title: "Collection légère",
      identityLine: "Titre : {title} · Série actuelle {streak} · Meilleure série {best}",
      titles: {
        newWatcher: "Nouveau spectateur",
        firstWinner: "Premier caméo gagnant",
        dramaRegular: "Habitué de l'arène",
        arenaProducer: "Producteur de victoire",
        roleSpecialist: "Spécialiste des rôles",
        streakDirector: "Réalisateur de série",
      },
      badges: {
        title: "Badges",
        empty: "Le premier badge chauffe encore",
        firstWin: "Première victoire",
        fiveShows: "Cinq shows",
        hotStreak: "Triplé brûlant",
        roleLoyalist: "Fan de {role}",
        comeback: "Monteur de comeback",
      },
    },
    reports: {
      subtitle: "Progression légère & rapports",
      title: "Archives des rapports",
      back: "Retour",
      statsTitle: "Stats fun",
      historyTitle: "5 dernières",
      masteryStat: "Focus maîtrise : {role} niv.{level}, {matches} apparitions",
      winningRoleStat: "Rôle gagnant : {role}, {wins} victoires",
      worstDefeatStat: "Pire défaite : {role} a subi {damage}",
      noMastery: "Focus maîtrise : aucune obsession pour l'instant",
      noWinningRole: "Rôle gagnant : le trophée hésite encore",
      noWorstDefeat: "Pire défaite : aucun drame archivé",
      historyEmpty: "Aucun rapport pour l'instant. Lance un combat rapide pour réveiller le carnet en coulisses.",
      historyLine: "#{index} {result} · {ownRole} vs {opponentRole} · dégâts {damage}",
      historyMeta: "{playlist} · {variant}",
      customMatch: "Match perso",
      noVariant: "Sans variante",
      itemModeRole: "Balle objet",
      noRole: "Rôle inconnu",
      emptyNotice: "La progression légère ne fait que suivre l'historique, sans bonus caché.",
      notice: "Collection et blagues seulement. Aucun bonus secret.",
      results: { win: "V", loss: "D", draw: "N" },
    },
    ...
    settings: {
      ...
      reducedShake: "Moins de secousses",
      highlightText: "Texte d'impact",
      compactReport: "Rapport compact",
      quickSettlement: "Résultat rapide",
      matchRecording: "Enregistrement ops",
      on: "Oui",
      off: "Non",
      ...
      statsInfo: "Statistiques : {analytics}. {iap} : aucun produit réel. Cette version n'affiche pas de publicités.",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          { title: "3. Statistiques et paiements", body: "Les statistiques peuvent être désactivées dans les réglages, et le retrait de l'accord les désactive jusqu'à une nouvelle confirmation. Cette version n'affiche pas de publicités et n'envoie aucune demande publicitaire. Les achats intégrés restent non configurés et aucun paiement n'est lancé." },
    ...
    result: { draw: "Égalité", winner: "{side} ({profession}) gagne", winnerNoProfession: "{side} gagne", again: "Rejouer", shareCard: "Carte de combat", nextItemChaos: "Chaos d'objets+", setup: "Préparation", backMain: "Retour au menu" },
    scenes: {
  ...
  de: {
    ...
    consent: {
      ...
      title: "Vor dem Start",
      intro: "Bitte lies und akzeptiere Datenschutzrichtlinie und Nutzungsvereinbarung.",
      privacy: "Datenschutz",
    ...
    main: {
      ...
      quickStart: "Schnellkampf",
      start: "Spiel starten",
      reports: "Berichte",
      settings: "Einstellungen & Recht",
      dailyProgressTitle: "Heutige Ziele",
      dailyWins: "Siege",
      dailyMatches: "Kämpfe",
      masteryTitle: "Meisterschaft",
      masteryLine: "{role} Lv.{level}, {matches} Kämpfe gespielt",
      masteryEmpty: "Nach einem Schnellkampf freigeschaltet",
      lastResultTitle: "Grund des letzten Sieges",
      funStatsLine: "Fun-Statistiken: Favorit {favorite} · größter Flop {flop} · kürzeste Niederlage {shortestLoss} · längstes Ziehen {longestMatch} · Kartenopfer {mapVictims}",
      statNone: "Keine",
      statSeconds: "{seconds}s",
    ...
    playlist: {
      title: "Heutige Playlist",
      rangedDerby: { title: "Fernkampf-Derby", tagline: "Pfeile und Zauber kämpfen um die Kamera" },
      shieldTrial: { title: "Schildprüfung", tagline: "Der Schild macht heute Überstunden" },
      assassinDare: { title: "Assassinenprobe", tagline: "Nah dran, schlechte Entscheidungen, gutes Drama" },
      frostBurn: { title: "Frostbrand", tagline: "Kontrolle und Feuer ruinieren jeden Plan" },
      summonerPanic: { title: "Beschwörer-Panik", tagline: "Kann der Bär die Sense stoppen?" },
      classicBrawl: { title: "Klassische Prügelei", tagline: "Speer und Klinge regeln es direkt" },
    },
    collection: {
      title: "Leichte Sammlung",
      identityLine: "Titel: {title} · Aktuelle Serie {streak} · Beste Serie {best}",
      titles: {
        newWatcher: "Neuer Zuschauer",
        firstWinner: "Erstes Sieger-Cameo",
        dramaRegular: "Arena-Stammgast",
        arenaProducer: "Sieg-Produzent",
        roleSpecialist: "Rollen-Spezialist",
        streakDirector: "Serien-Regisseur",
      },
      badges: {
        title: "Abzeichen",
        empty: "Das erste Abzeichen wärmt noch auf",
        firstWin: "Erster Sieg",
        fiveShows: "Fünf Shows",
        hotStreak: "Dreifach heiß",
        roleLoyalist: "{role}-Loyalist",
        comeback: "Comeback-Editor",
      },
    },
    reports: {
      subtitle: "Leichte Entwicklung & Berichte",
      title: "Berichtsarchiv",
      back: "Zurück",
      statsTitle: "Fun-Statistiken",
      historyTitle: "Letzte 5",
      masteryStat: "Meisterschaftsfokus: {role} Lv.{level}, {matches} Einsätze",
      winningRoleStat: "Siegerrolle: {role}, {wins} Siege",
      worstDefeatStat: "Schlimmste Niederlage: {role} kassierte {damage}",
      noMastery: "Meisterschaftsfokus: noch keine Obsession",
      noWinningRole: "Siegerrolle: der Pokal ist noch unentschlossen",
      noWorstDefeat: "Schlimmste Niederlage: noch kein Desaster archiviert",
      historyEmpty: "Noch keine Berichte. Starte einen Schnellkampf, dann wacht das Backstage-Notizbuch auf.",
      historyLine: "#{index} {result} · {ownRole} vs {opponentRole} · Schaden {damage}",
      historyMeta: "{playlist} · {variant}",
      customMatch: "Eigenes Match",
      noVariant: "Keine Variante",
      itemModeRole: "Item-Ball",
      noRole: "Unbekannte Rolle",
      emptyNotice: "Leichte Entwicklung speichert nur Historie, ohne versteckte Boni.",
      notice: "Nur Sammlung und Gags. Keine geheimen Statusboni.",
      results: { win: "S", loss: "N", draw: "U" },
    },
    ...
    settings: {
      ...
      reducedShake: "Weniger Wackeln",
      highlightText: "Treffertext",
      compactReport: "Kompakter Bericht",
      quickSettlement: "Schnelles Ergebnis",
      matchRecording: "Ops-Aufnahme",
      on: "Ein",
      off: "Aus",
      ...
      statsInfo: "Analyse: {analytics}. {iap}: keine echten Produkte. Dieser Build zeigt keine Werbung.",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          { title: "3. Analyse und Zahlung", body: "Analyse kann in den Einstellungen deaktiviert werden; das Widerrufen der Zustimmung deaktiviert sie bis zur erneuten Bestätigung. Dieser Build zeigt keine Werbung und sendet keine Anzeigenanfragen. In-App-Käufe bleiben nicht konfiguriert und es wird keine Zahlung gestartet." },
    ...
    result: { draw: "Unentschieden", winner: "{side} ({profession}) gewinnt", winnerNoProfession: "{side} gewinnt", again: "Noch einmal", shareCard: "Kampfkarte", nextItemChaos: "Item-Chaos+", setup: "Kampf-Setup", backMain: "Zurück zum Menü" },
    scenes: {
  ...
  ar: {
    ...
    consent: {
      ...
      title: "قبل البدء",
      intro: "يرجى قراءة سياسة الخصوصية واتفاقية المستخدم والموافقة عليهما.",
    ...
    main: {
      ...
      quickStart: "قتال سريع",
      start: "ابدأ اللعبة",
      reports: "التقارير",
      settings: "الإعدادات والاتفاقيات",
      dailyProgressTitle: "أهداف اليوم",
      dailyWins: "الانتصارات",
      dailyMatches: "المعارك",
      masteryTitle: "الإتقان",
      masteryLine: "{role} المستوى {level}، تم لعب {matches} مباراة",
      masteryEmpty: "يفتح بعد قتال سريع واحد",
      lastResultTitle: "سبب آخر فوز",
      funStatsLine: "إحصاءات ممتعة: المفضل {favorite} · الأكثر تعثرا {flop} · أسرع خسارة {shortestLoss} · أطول شد وجذب {longestMatch} · ضحايا الخريطة {mapVictims}",
      statNone: "لا شيء",
      statSeconds: "{seconds}ث",
      notice: "تعمل الإحصاءات بعد الموافقة فقط. لا يعرض هذا الإصدار إعلانات ولا يرسل طلبات إعلانية. عند النشر، صنفه كقتال كرتوني/خيالي خفيف.",
    },
    playlist: {
      title: "قائمة اليوم",
      rangedDerby: { title: "دربي بعيد المدى", tagline: "السهام والتعاويذ تتصارع على الكاميرا" },
      shieldTrial: { title: "اختبار الدرع", tagline: "الدرع يعمل لساعات إضافية اليوم" },
      assassinDare: { title: "تحدي القاتل", tagline: "مسافة قريبة وقرارات سيئة ودراما ممتازة" },
      frostBurn: { title: "صقيع ولهيب", tagline: "التحكم والنار يفسدان كل خطة" },
      summonerPanic: { title: "ذعر المستدعي", tagline: "هل يستطيع الدب إيقاف المنجل؟" },
      classicBrawl: { title: "عراك كلاسيكي", tagline: "الرمح والنصل يحسمانها مباشرة" },
    },
    collection: {
      title: "مجموعة خفيفة",
      identityLine: "اللقب: {title} · السلسلة الحالية {streak} · أفضل سلسلة {best}",
      titles: {
        newWatcher: "متفرج جديد",
        firstWinner: "أول ظهور فائز",
        dramaRegular: "ضيف دائم في الساحة",
        arenaProducer: "منتج الانتصار",
        roleSpecialist: "متخصص الأدوار",
        streakDirector: "مخرج السلسلة",
      },
      badges: {
        title: "الشارات",
        empty: "الشارة الأولى ما زالت تسخن",
        firstWin: "أول فوز",
        fiveShows: "خمسة عروض",
        hotStreak: "ثلاثية ساخنة",
        roleLoyalist: "مخلص لـ {role}",
        comeback: "محرر العودة",
      },
    },
    reports: {
      subtitle: "تقدم خفيف وتقارير",
      title: "أرشيف التقارير",
      back: "رجوع",
      statsTitle: "إحصاءات ممتعة",
      historyTitle: "آخر 5",
      masteryStat: "تركيز الإتقان: {role} المستوى {level}، {matches} ظهور",
      winningRoleStat: "الدور الفائز: {role}، {wins} انتصار",
      worstDefeatStat: "أسوأ هزيمة: {role} تلقى {damage}",
      noMastery: "تركيز الإتقان: لا هوس بعد",
      noWinningRole: "الدور الفائز: الكأس لم يحسم أمره بعد",
      noWorstDefeat: "أسوأ هزيمة: لا كارثة محفوظة بعد",
      historyEmpty: "لا توجد تقارير بعد. ابدأ قتالا سريعا ليصحو دفتر الكواليس.",
      historyLine: "#{index} {result} · {ownRole} ضد {opponentRole} · الضرر {damage}",
      historyMeta: "{playlist} · {variant}",
      customMatch: "مباراة مخصصة",
      noVariant: "بلا متغير",
      itemModeRole: "كرة الأدوات",
      noRole: "دور غير معروف",
      emptyNotice: "التقدم الخفيف يسجل التاريخ فقط، من دون زيادات مخفية.",
      notice: "مجموعة ونكات فقط. لا توجد زيادات سرية.",
      results: { win: "ف", loss: "خ", draw: "ت" },
    },
    ...
    settings: {
      ...
      reducedShake: "اهتزاز أقل",
      highlightText: "نص الضربة",
      compactReport: "تقرير مختصر",
      quickSettlement: "نتيجة سريعة",
      matchRecording: "تسجيل العمليات",
      on: "تشغيل",
      off: "إيقاف",
      ...
      statsInfo: "الإحصاءات: {analytics}. {iap}: لا منتجات حقيقية. لا يعرض هذا الإصدار إعلانات.",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          { title: "3. الإحصاءات والدفع", body: "يمكن إيقاف الإحصاءات من الإعدادات، كما أن سحب الموافقة يوقفها حتى تأكيد الشروط مرة أخرى. لا يعرض هذا الإصدار إعلانات ولا يرسل طلبات إعلانية. يبقى الشراء داخل التطبيق غير مهيأ ولا تبدأ أي عملية دفع." },
    ...
    result: { draw: "تعادل", winner: "{side} ({profession}) فازت", winnerNoProfession: "{side} فازت", again: "جولة أخرى", shareCard: "بطاقة القتال", nextItemChaos: "فوضى الأدوات+", setup: "إعداد القتال", backMain: "العودة للقائمة" },
    scenes: {
...
translations.ja = {
  ...
  consent: {
    subtitle: "公開前の確認",
    title: "始める前に",
    intro: "プライバシーポリシーとユーザー規約を読んで同意してください。",
    privacy: "プライバシーポリシー",
    terms: "ユーザー規約",
  ...
  main: {
    ...
    reports: "戦報",
    settings: "設定と規約",
    dailyProgressTitle: "今日の目標",
    dailyWins: "勝利",
    dailyMatches: "対戦",
    masteryTitle: "熟練度",
    masteryLine: "{role} Lv.{level}、{matches} 戦出場",
    masteryEmpty: "クイックバトル1回で解放",
    lastResultTitle: "前回勝利の決め手",
    funStatsLine: "観戦メモ：推し {favorite} ・事故役 {flop} ・最短敗北 {shortestLoss} ・最長の粘り {longestMatch} ・マップ被害 {mapVictims}",
    statNone: "なし",
  ...
  playlist: {
    title: "今日の対戦リスト",
    rangedDerby: { title: "遠距離ダービー", tagline: "矢と魔法が主役争い" },
    shieldTrial: { title: "盾の試練", tagline: "今日は盾が残業中" },
    assassinDare: { title: "アサシン度胸試し", tagline: "近距離の悪手がドラマになる" },
    frostBurn: { title: "氷と炎の事故", tagline: "制圧と炎上で計画が崩れる" },
    summonerPanic: { title: "召喚師パニック", tagline: "クマは鎌を止められるか？" },
    classicBrawl: { title: "王道乱闘", tagline: "槍と大刀が正面から決着" },
  },
  collection: {
    title: "ライトコレクション",
    identityLine: "称号：{title} ・ 現在連勝 {streak} ・ 最高連勝 {best}",
    titles: {
      newWatcher: "新米観客",
      firstWinner: "初勝利カメオ",
      dramaRegular: "闘技場常連",
      arenaProducer: "勝利プロデューサー",
      roleSpecialist: "職業スペシャリスト",
      streakDirector: "連勝ディレクター",
    },
    badges: {
      title: "バッジ",
      empty: "最初のバッジはまだ準備中",
  ...
  reports: {
    ...
    statsTitle: "観戦メモ",
    historyTitle: "直近5戦",
    masteryStat: "熟練度注目：{role} Lv.{level}、{matches} 戦出場",
    winningRoleStat: "勝ち役：{role}、{wins} 勝",
    worstDefeatStat: "最悪の敗北：{role} が {damage} を受けた",
    noMastery: "熟練度注目：まだ執着なし",
    noWinningRole: "勝ち役：トロフィーはまだ迷っている",
    noWorstDefeat: "最悪の敗北：まだ惨事なし",
    historyEmpty: "まだ戦報がありません。クイックバトルで裏方メモを起こしてください。",
    historyLine: "#{index} {result} ・ {ownRole} vs {opponentRole} ・ ダメージ {damage}",
    historyMeta: "{playlist} ・ {variant}",
    customMatch: "カスタム対戦",
    noVariant: "変化なし",
    itemModeRole: "アイテムボール",
    noRole: "不明な職業",
    emptyNotice: "ライト成長は履歴だけを記録し、能力値は上げません。",
    notice: "収集とネタだけ。隠し強化はありません。",
    results: { win: "勝", loss: "敗", draw: "分" },
  },
  setup: {
    subtitle: "バトル設定",
    sceneLabel: "シーン",
  ...
  settings: {
    ...
    music: "BGM",
    soundEffects: "効果音",
    reducedShake: "画面揺れを弱める",
    highlightText: "ハイライト字幕",
    compactReport: "簡潔な戦報",
    quickSettlement: "高速決着",
    matchRecording: "運営向け録画",
    on: "オン",
    off: "オフ",
    ...
    restore: "購入を復元",
    withdraw: "同意を取り消す",
    statsInfo: "分析：{analytics}。{iap}：実際の商品は未設定です。このビルドでは広告を表示しません。",
  ...
  legal: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "3. 分析、決済", body: "分析は設定でオフにでき、同意を取り消すと再確認まで無効になります。このビルドでは広告を表示せず、広告リクエストも送信しません。アプリ内購入は未設定で、決済フローは開始しません。" },
  ...
  result: { draw: "引き分け", winner: "{side}（{profession}）が勝利", winnerNoProfession: "{side} が勝利", again: "もう一戦", shareCard: "戦報カード", nextItemChaos: "アイテム大乱戦+", setup: "バトル設定", backMain: "メインメニューへ" },
  scenes: {
...
export function translate(locale, key, replacements = {}) {
  const normalizedLocale = normalizeLocale(locale);
  const value =
    getPath(translations[normalizedLocale], key) ??
    (normalizedLocale !== "en" && normalizedLocale !== FALLBACK_LOCALE ? getPath(translations.en, key) : undefined) ??
    getPath(translations[FALLBACK_LOCALE], key);
...
export function getLocalizedLegalDocument(locale, type, replacements = {}) {
  ...
  const normalizedLocale = normalizeLocale(locale);
  const document =
    getPath(translations[normalizedLocale], `legal.${documentKey}`) ??
    (normalizedLocale !== "en" && normalizedLocale !== FALLBACK_LOCALE ? getPath(translations.en, `legal.${documentKey}`) : undefined) ??
    getPath(translations[FALLBACK_LOCALE], `legal.${documentKey}`);
