...
const translations = {
  zh: {
    ...
    guide: {
      quickStart: "先点这里，30 秒看完一场小剧场。",
      autoBattle: "职业会自动战斗，你只管盯住谁先打出节奏。",
      watchHighlights: "第二局重点看高光字幕：大伤、技能命中、残血反击都会跳出来。",
    },
    highlight: {
      bigHit: "{side} 关键一击 -{damage}",
      skillHit: "{side} 的 {source} 命中！",
      clutchHit: "{side} 残血还敢回头！",
      clutchFinish: "{side} 濒死反杀！",
      finisher: "{side} 收掉比赛！",
    },
    ads: {
    ...
    messages: {
      ...
      contactOpened: "已打开邮件入口：{email}",
      contactOpenFailed: "未能打开邮件入口，请手动发送至 {email}",
      quickStart: "快速开战：{professionA} 对阵 {professionB}",
      quickStartPlaylist: "今日对局「{title}」：{professionA} 对阵 {professionB}",
    ...
    playlist: {
      title: "今日对局",
      rangedDerby: { title: "远程内战", tagline: "箭和法术谁先把镜头打穿" },
      shieldTrial: { title: "铁盾受难日", tagline: "盾牌今天要加班" },
      assassinDare: { title: "刺客试胆", tagline: "敢不敢贴脸赌一刀" },
      frostBurn: { title: "冰火事故", tagline: "控场和地火互相拆台" },
      summonerPanic: { title: "召唤师慌张", tagline: "熊灵能不能拦住镰刀" },
      classicBrawl: { title: "老派互砍", tagline: "长矛大刀直接讲道理" },
    },
    collection: {
      title: "轻收藏",
      identityLine: "称号：{title} · 当前连胜 {streak} · 最高连胜 {best}",
      titles: {
        newWatcher: "新晋看戏人",
        firstWinner: "首胜入镜",
        dramaRegular: "斗技场常驻观众",
        arenaProducer: "胜利制片人",
        roleSpecialist: "职业专精导演",
        streakDirector: "连胜总导演",
      },
      badges: {
        title: "徽章",
        empty: "还在酝酿第一枚",
    ...
    variants: {
      ...
      supplyDrop: { title: "补给插播", description: "比赛中会掉落临时补给，谁抢到谁加戏。" },
      hazardRush: { title: "危险插播", description: "场地会突然丢下火、刺和冰，别只盯着对手。" },
      eventNotice: { title: "地图事件！", description: "{object}掉进场地，剧情加速。" },
      objects: {
        smallHealth: "小血包",
        largeHealth: "大血包",
        thorns: "尖刺",
    ...
    reports: {
      ...
      statsTitle: "娱乐统计",
      historyTitle: "最近 5 场",
      masteryStat: "熟练度焦点：{role} Lv.{level}，上场 {matches} 局",
      winningRoleStat: "常胜职业：{role}，已经拿下 {wins} 胜",
      worstDefeatStat: "最惨败局：{role} 被打成 {damage}",
      noMastery: "熟练度焦点：还没形成执念",
      noWinningRole: "常胜职业：奖杯还没站队",
      noWorstDefeat: "最惨败局：目前还没有惨案",
      historyEmpty: "还没有战报。先点一次快速开战，让后台开始记小本本。",
      historyLine: "#{index} {result} · {ownRole} vs {opponentRole} · 伤害 {damage}",
      historyMeta: "{playlist} · {variant}",
      customMatch: "自定义对局",
      noVariant: "无变体",
      itemModeRole: "道具球",
      noRole: "未知职业",
      emptyNotice: "轻成长只记录观赛资历，不会给职业加数值。",
      notice: "这些只影响收藏和吐槽，不会偷偷加属性。",
      results: { win: "胜", loss: "负", draw: "平" },
    },
    setup: {
      subtitle: "开战设置",
      sceneLabel: "场景",
    ...
    result: {
      ...
      reasonDamage: [
        ...
        "{side} 把输出表打成了独角戏，{damage} 点伤害像盖章一样往下砸。",
        "{side} 没有铺垫，只有连续重拳，伤害数字一路把镜头推到终局。",
      ],
      reasonAttack: [
        "{side} 像踩着鼓点进攻，{count} 次命中一下一下把场面敲碎。",
        "{side} 今天手感烫得离谱，{count} 次命中像连招没断过。",
        "{side} 不等奇迹降临，自己把 {count} 次命中砸成了结局。",
        "{side} 的节奏密得像鼓点，对面刚站稳就又被点名。",
        "{side} 这局不讲玄学，讲的是命中率和持续施压。",
      ],
      reasonSpecial: [
        "{side} 的 {source} 一出手，像片场突然换了主角。",
        "{side} 靠 {source} 把局势从悬疑片打成爽片。",
        "{side} 真正的转折点不是碰撞，是 {source} 落下来的那一秒。",
        "{side} 把 {source} 用成了剧情炸点，观众席都坐直了。",
        "{source} 一亮相，{side} 的胜利进度条直接加速。",
      ],
      reasonSource: [
        "{side} 把 {source} 玩成了招牌节目，对面全程被迫买票观看。",
        "{side} 抓着 {source} 不放，硬是把小优势写成大结局。",
        "{side} 靠 {source} 一路加戏，最后把胜利灯牌自己点亮。",
        "{side} 今天的关键词就三个字：{source}。剩下都是余震。",
        "{side} 靠 {source} 反复敲门，最后门和比赛一起开了。",
      ],
      reasonEndurance: [
        "{side} 前半段像在攒镜头，后半段突然开始收割剧情。",
        "{side} 把这局拖成耐力大片，最后对面先掉线的是气势。",
        "{side} 打到后面越打越稳，像在残局里铺好了红毯。",
        "{side} 没急着赢，先把对面拖进自己的节奏里。",
        "{side} 越到后面越像主角，残局一开，气场直接接管。",
      ],
      reasonClose: [
        "{side} 赢得像电影最后三秒拆弹，手一抖就要改结局。",
        "{side} 这把胜利薄得像纸，但最后一下就是写上去了。",
        "{side} 没有大优势，只有一个更会抢镜的收尾。",
        "{side} 这把赢得太险，结算页都像在擦汗。",
        "{side} 只多站住了半口气，但半口气也能领奖。",
      ],
      reasonClutch: [
        "{side} 血条都快熄灯了，最后硬是把灯又拍亮。",
        "{side} 用残血写完结局，这不是胜利，这是现场急救成功。",
        "{side} 赢得像从悬崖边把奖杯拽回来。",
        "{side} 最后那点血没有投降，反而开始抢戏。",
      ],
      reasonStomp: [
        "{side} 这局不是赢，是把比赛按进快进键。",
        "{side} 把对面打成背景板，{damage} 点伤害像片尾字幕一样滚过去。",
        "{side} 一路碾过去，场地都像提前知道谁会赢。",
        "{side} 的优势大到不像战术，更像天气预报。",
      ],
      reasonComeback: [
        "{side} 前面像要下线，后面突然改写剧本。",
        "{side} 被压了一段，但反手把逆风局剪成了高燃预告。",
        "{side} 这把赢在不认命，落后只是剧情需要。",
        "{side} 先让局势紧张起来，再亲手把它掀翻。",
      ],
      reasonScrappy: [
        "这局双方像在互相试麦，打着打着居然也打出了结局。",
        "两边都不算优雅，但胜负就是从这些小碰小撞里挤出来的。",
        "这不是名场面，这是菜刀互啄剧场，但它真的有赢家。",
        "双方都在犯错，区别是有人把错误犯得更有戏。",
      ],
      reasonSkillWhiff: [
        "{side} 赢得不复杂：对面技能空得太有节目效果。",
        "{side} 等到了对面的空档，技能没落地，胜利先落地了。",
        "{side} 抓住了那几次空大，像抓住了剧情漏风的窗。",
        "{side} 没急着爆发，只等对面把关键镜头交丢。",
      ],
      reasonDraw: [
        "两边像约好了一起退场，烟尘散开，只剩一个平局。",
        "这局最后不是胜利，是双主角同时倒在聚光灯下。",
        "谁都不肯让，最后把比赛打成了同步谢幕。",
        "两边都冲到终点线前摔倒，裁判只能宣布一起谢幕。",
        "胜利奖杯还没递出去，双方已经同时躺平。",
      ],
      lessonStomp: [
        "败因回放：{side} 没挡住第一波滚雪球，后面只能追着比分跑。",
        "败方小结：{side} 的防线太早漏风，优势被对面越吹越大。",
        "后台吐槽：{side} 不是输在最后一下，是前面坑挖太深。",
      ],
      lessonTempo: [
        "败因回放：{side} 出手慢了半拍，节奏被对面抢走就没还回来。",
        "败方小结：{side} 一直在等机会，但机会已经坐对面车走了。",
        "后台吐槽：{side} 的命中像断续剧，关键段落总是空白。",
      ],
      lessonClose: [
        "败因回放：{side} 只差一点点，但一点点在结算页也算很多。",
        "败方小结：{side} 离翻盘很近，近到让人想立刻重赛。",
        "后台吐槽：{side} 输得不难看，就是差一个更会抢镜的收尾。",
      ],
      lessonPressure: [
        "败因回放：{side} 被持续压着换血，场面越打越窄。",
        "败方小结：{side} 没崩，但每次小亏都在悄悄叠账单。",
        "后台吐槽：{side} 不是没机会，是机会都被对面提前预订了。",
      ],
      lessonSkillWhiff: [
        "败因回放：{side} 的关键技能没接住镜头，空档全送给对面。",
        "败方小结：{side} 技能喊得很响，落点有点害羞。",
        "后台吐槽：{side} 的空大太响亮，连结算页都听见了。",
      ],
      lessonDraw: [
        "后台小结：没有败方，只有两个同时把剧本撕碎的主角。",
        "后台小结：这局不用找锅，锅和奖杯一起失踪了。",
        "后台小结：双方都没赢，但节目效果确实到账。",
      ],
  ...
  en: {
    ...
    hud: { shake: "Shake" },
    guide: {
      quickStart: "Start here: one tiny arena drama in about 30 seconds.",
      autoBattle: "Professions fight automatically. Watch who grabs the tempo first.",
      watchHighlights: "Round two tip: big hits, skill lands, and clutch counters pop as highlights.",
    },
    highlight: {
      bigHit: "{side} key hit -{damage}",
      skillHit: "{side}'s {source} landed!",
      clutchHit: "{side} swings back at low HP!",
      clutchFinish: "{side} steals it at the edge!",
      finisher: "{side} closes the match!",
    },
    ads: {
    ...
    messages: {
      ...
      contactOpened: "Email contact opened: {email}",
      contactOpenFailed: "Could not open email contact. Send manually to {email}",
      quickStart: "Quick battle: {professionA} vs {professionB}",
      quickStartPlaylist: "Today's duel \"{title}\": {professionA} vs {professionB}",
    ...
    playlist: {
      ...
      rangedDerby: { title: "Ranged Derby", tagline: "Arrows and spells fight for the camera" },
      shieldTrial: { title: "Shield Trial", tagline: "The shield is working overtime" },
      assassinDare: { title: "Assassin Dare", tagline: "Close range, bad decisions, great drama" },
      frostBurn: { title: "Frost Burn", tagline: "Control and fire keep ruining plans" },
      summonerPanic: { title: "Summoner Panic", tagline: "Can the bear stop the scythe?" },
      classicBrawl: { title: "Old-School Brawl", tagline: "Spear and blade settle it directly" },
    },
    collection: {
      title: "Light Collection",
      identityLine: "Title: {title} · Current streak {streak} · Best streak {best}",
      titles: {
        newWatcher: "New Spectator",
        firstWinner: "First-Win Cameo",
        dramaRegular: "Arena Regular",
        arenaProducer: "Victory Producer",
        roleSpecialist: "Role Specialist",
        streakDirector: "Streak Director",
      },
      badges: {
        title: "Badges",
        empty: "First badge still warming up",
        firstWin: "First Win",
        fiveShows: "Five Shows",
        hotStreak: "Triple Heat",
        roleLoyalist: "{role} Loyalist",
        comeback: "Comeback Editor",
      },
    },
    variants: {
      ...
      supplyDrop: { title: "Supply Drop", description: "Temporary supplies drop mid-match for whoever steals the scene." },
      hazardRush: { title: "Hazard Rush", description: "Fire, thorns, and ice can suddenly crash the fight." },
      eventNotice: { title: "Map Event!", description: "{object} landed in the arena. Plot speed increased." },
      objects: {
        smallHealth: "Small Heal",
        largeHealth: "Big Heal",
        thorns: "Thorns",
    ...
    reports: {
      subtitle: "Light Growth & Reports",
      title: "Report Archive",
      back: "Back",
      statsTitle: "Fun Stats",
      historyTitle: "Recent 5",
      masteryStat: "Mastery focus: {role} Lv.{level}, {matches} appearances",
      winningRoleStat: "Winning role: {role}, {wins} wins",
      worstDefeatStat: "Worst loss: {role} got boxed into {damage}",
      noMastery: "Mastery focus: no obsession yet",
      noWinningRole: "Winning role: the trophy is still undecided",
      noWorstDefeat: "Worst loss: no disaster archived yet",
      historyEmpty: "No reports yet. Start a quick battle and the backstage notebook wakes up.",
      historyLine: "#{index} {result} · {ownRole} vs {opponentRole} · damage {damage}",
      historyMeta: "{playlist} · {variant}",
      customMatch: "Custom match",
      noVariant: "No variant",
      itemModeRole: "Item Ball",
      noRole: "Unknown Role",
      emptyNotice: "Light growth tracks show history only; it never boosts stats.",
      notice: "Collection and jokes only. No hidden stat boosts.",
      results: { win: "W", loss: "L", draw: "D" },
    },
    setup: {
    ...
    result: {
      ...
      reasonDamage: [
        ...
        "{side} turned the damage chart into a solo act and stamped {damage} damage all over it.",
        "{side} skipped the warm-up. The numbers just kept landing until the ending had no room left.",
      ],
      reasonAttack: [
        ...
        "{side} kept the rhythm tight. Every time the other side stood up, another hit arrived.",
        "{side} won this one with pressure, timing, and absolutely no patience for drama breaks.",
      ],
      reasonSpecial: [
        ...
        "{side} made {source} the explosion point, and the whole arena sat up.",
        "Once {source} showed up, {side}'s win meter started sprinting.",
      ],
      reasonSource: [
        ...
        "{side}'s keyword today was {source}. Everything else was aftershock.",
        "{side} kept knocking with {source} until the door and the match both opened.",
      ],
      reasonEndurance: [
        ...
        "{side} did not rush the win; they dragged the match into their rhythm first.",
        "{side} looked more like the lead character with every late-game second.",
      ],
      reasonClose: [
        ...
        "{side} won so narrowly the result screen needed a deep breath.",
        "{side} only had half a breath left, but half a breath can still hold a trophy.",
      ],
      reasonClutch: [
        "{side}'s health bar was almost out of lights, then someone slapped the switch back on.",
        "{side} finished the ending at low HP. That was less victory, more emergency theater.",
        "{side} dragged the trophy back from the ledge.",
        "{side}'s last bit of health refused to leave quietly.",
      ],
      reasonStomp: [
        "{side} did not just win; they put the match on fast-forward.",
        "{side} turned the other side into background scenery while {damage} damage rolled by.",
        "{side} rolled through so hard the arena seemed to know the ending early.",
        "{side}'s lead was less like tactics and more like a weather report.",
      ],
      reasonComeback: [
        "{side} looked ready to disappear, then rewrote the script.",
        "{side} got pressed early, then cut the comeback trailer themselves.",
        "{side} won by refusing the obvious ending. The deficit was only plot setup.",
        "{side} let the tension build, then flipped the whole table.",
      ],
      reasonScrappy: [
        "Both sides played like they were testing microphones, and somehow a result appeared.",
        "Nobody looked elegant, but the win crawled out of all those tiny bumps.",
        "This was not a highlight reel. It was a scrappy duel with a surprisingly loud ending.",
        "Both sides made mistakes; one side just made theirs with better timing.",
      ],
      reasonSkillWhiff: [
        "{side} did not need a complex plan. The other side's misses brought snacks.",
        "{side} waited out the whiffs. The skills missed, the win did not.",
        "{side} caught those empty casts like loose plot threads.",
        "{side} stayed patient until the other side dropped the key scene.",
      ],
      reasonDraw: [
        ...
        "Both sides tripped at the finish line, so the referee called it a shared exit.",
        "The trophy was still waiting when both fighters hit the floor.",
      ],
      lessonStomp: [
        "Loss replay: {side} could not stop the first snowball, then spent the rest chasing it.",
        "Loser note: {side}'s defense leaked too early, and the lead kept growing through the crack.",
        "Backstage note: {side} did not lose at the end; the hole was dug much earlier.",
      ],
      lessonTempo: [
        "Loss replay: {side} acted half a beat late, and the tempo never came back.",
        "Loser note: {side} waited for an opening after the opening had already left.",
        "Backstage note: {side}'s hits played like a broken series, with gaps in every key scene.",
      ],
      lessonClose: [
        "Loss replay: {side} was one touch away, but one touch is huge on the result screen.",
        "Loser note: {side} got close enough to make an immediate rematch feel personal.",
        "Backstage note: {side} lost cleanly enough, just without the final spotlight steal.",
      ],
      lessonPressure: [
        "Loss replay: {side} kept bleeding tiny trades until the arena felt smaller.",
        "Loser note: {side} did not collapse; the small losses just kept sending invoices.",
        "Backstage note: {side} had chances, but the other side reserved them first.",
      ],
      lessonSkillWhiff: [
        "Loss replay: {side}'s key skills missed their cue and handed over the stage.",
        "Loser note: {side}'s skills made noise, then got shy about landing.",
        "Backstage note: {side}'s whiffs were loud enough for the result screen to hear.",
      ],
      lessonDraw: [
        "Backstage note: no loser, just two leads tearing up the script at the same time.",
        "Backstage note: no blame to assign. The trophy and the plot both vanished.",
        "Backstage note: nobody won, but the show value absolutely arrived.",
      ],
  ...
  fr: {
    ...
    messages: {
      ...
      contactOpened: "Contact e-mail ouvert : {email}",
      contactOpenFailed: "Impossible d'ouvrir l'e-mail. Envoyez-le à {email}",
  ...
  de: {
    ...
    messages: {
      ...
      contactOpened: "E-Mail-Kontakt geöffnet: {email}",
      contactOpenFailed: "E-Mail konnte nicht geöffnet werden. Sende manuell an {email}",
  ...
  ar: {
    ...
    messages: {
      ...
      contactOpened: "تم فتح البريد للتواصل: {email}",
      contactOpenFailed: "تعذر فتح البريد. أرسل يدويا إلى {email}",
    ...
    settings: {
      ...
      contactDeveloper: "التواصل مع المطوّر",
      analytics: "الإحصاءات",
      ads: "الإعلانات",
      privacy: "سياسة الخصوصية",
      terms: "اتفاقية المستخدم",
...
translations.ja = {
  ...
  messages: {
    ...
    contactOpened: "メール連絡先を開きました：{email}",
    contactOpenFailed: "メール連絡先を開けませんでした。{email} へ手動で送信してください",
