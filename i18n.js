...
const translations = {
  zh: {
    ...
    main: {
      subtitle: "主菜单",
      title: "准备开战",
      summary: "{sideA}：{professionA}  /  {sideB}：{professionB}",
      start: "开始游戏",
      settings: "设置与协议",
  ...
  en: {
    ...
    scenes: { classic: { name: "Classic Arena", description: "Auto battle in a compact arena" } },
    professions: {
  ...
  fr: {
    ...
    scenes: { classic: { name: "Arène classique", description: "Combat auto dans une petite arène" } },
    professions: {
  ...
  de: {
    ...
    scenes: { classic: { name: "Klassische Arena", description: "Auto-Kampf in kompakter Arena" } },
    professions: {
  ...
  ar: {
    ...
    scenes: { classic: { name: "الساحة الكلاسيكية", description: "قتال تلقائي في ساحة صغيرة" } },
    professions: {
